...
~~~scala
libraryDependencies += "ch.jodersky" %% "akka-serial-core" % "4.1.4"
~~~
...
~~~scala
libraryDependencies += "ch.jodersky" % "akka-serial-native" % "4.1.4" % "runtime"
~~~
...
The following is a general guide on the usage of akak-serial. If you prefer a complete example, check out the code contained in the [samples](https://github.com/jodersky/akka-serial/tree/v4.1.4/samples) directory.
...
~~~scala
libraryDependencies += "ch.jodersky" %% "akka-serial-stream" % "4.1.4"
~~~
