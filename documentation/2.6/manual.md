...
libraryDependencies += "com.github.jodersky" %% "flow-core" % "2.6.0"
~~~
...
~~~scala
libraryDependencies += "com.github.jodersky" % "flow-native" % "2.6.0" % "runtime"
~~~
...
### Maximum Portability
Start by obtaining a copy of the native library, either by [building flow](./developer) or by [downloading]({{site.url}}/downloads/) a native archive. In order to work with this version of flow, native libraries need to be of major version 3 and minor version greater or equal to 0.
...
The following is a general guide on the usage of flow. If you prefer a complete example, check out the code contained in the [flow-samples](https://github.com/jodersky/flow/tree/v2.6.0/flow-samples) directory.
...
~~~scala
libraryDependencies += "com.github.jodersky" %% "flow-stream" % "2.6.0"
~~~
